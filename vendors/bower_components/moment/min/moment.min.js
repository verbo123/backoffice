!function (e, t) {
    ...
    var pn = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        wn = "Janvier_Fevrier_Mars_Avril_Mai_Juin_Juillet_Août_Septembre_Octobre_Novembre_Decembre".split("_"),
        vn = "Jan_Fev_Mar_Avr_Mai_Juin_Jui_Août_Sep_Oct_Nov_Dec".split("_"), Mn = sn, kn = sn;
    ...
    var Dn = "Dimanche_Lundi_Mardi_Mercredi_Jeudi_Vendredi_Samedi".split("_"),
        Yn = "Dim_Lun_Mar_Mer_Jeu_Ven_Sam".split("_"), On = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), xn = sn, Tn = sn,
        bn = sn;
