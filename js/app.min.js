...
$(window).on("load", function () {
    ...
    if ($(".data-table")[0]) {
        $(".data-table").DataTable({
            autoWidth: !1,
            responsive: !0,
            lengthMenu: [[15, 30, 45, -1], ["15 lignes", "30 lignes", "45 lignes", "Tous"]],
            language: {searchPlaceholder: "Effectuez une recherche..."},
            dom: "Blfrtip",
            buttons: [{extend: "excelHtml5", title: "Exporter les données"}, {
                extend: "csvHtml5",
